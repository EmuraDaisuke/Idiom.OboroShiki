...
## **Msvc**
~~~
cl Main.cpp Pimpl.cpp Phantasma.cpp -Ox -EHsc -openmp -Fe:TestMsvc.exe
TestMsvc.exe
~~~
...
## **g++**
~~~
g++ Main.cpp Pimpl.cpp Phantasma.cpp -O3 -fopenmp -o TestG++.exe
TestG++.exe
~~~
...
## 所感
同じunique_ptrであれば、"Pimpl"と"Phantasma"で、差がないことが分かります。  
